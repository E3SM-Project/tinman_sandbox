...
#include "gptl/gptl.h"
    ...
    (defined(HOMMEXX_DEFAULT_SPACE) &&                                         \
     defined(KOKKOS_ENABLE_CUDA)) // Can't use GPTL timers on CUDA
...
#pragma message                                                                \
    "GProf support for this is undocumented and subject to change, this may fail as a result"
