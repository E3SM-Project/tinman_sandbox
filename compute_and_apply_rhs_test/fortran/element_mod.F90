...
!Ask whether this is CAM default
!Asked. Not really, only when looking at energy, so this is not a default.
#undef ENERGY_DIAGNOSTICS 
...
! Disabling this to avoid adding 2 more modules.
