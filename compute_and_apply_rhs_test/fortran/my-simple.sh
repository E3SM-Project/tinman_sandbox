...
gfortran -fopenmp -DHOMP=1 -DORIG=0 -DSTVER1=1 -DSTVER2=0 -DSTVER3=0 -DSTVER4=0 config1.h config2.h config3.h config4.h kinds.F90  utils_mod.F90 coordinate_systems_mod.F90 element_state_mod.F90 element_mod.F90 physical_constants.F90 derivative_mod_base.F90 hybvcoord_mod.F90 routine_mod_ST.F90 main-simplified.F90 -o simple-s1omp
