...
ELSE ()
  ...
  ELSE ()
    ...
    ELSEIF (CMAKE_C_COMPILER_ID STREQUAL XL)
      SET(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -O3 -g -qmaxmem=-1")
  ...
  ELSE ()
    ...
    ELSEIF (CMAKE_CXX_COMPILER_ID STREQUAL XL)
      SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -O3 -g -qmaxmem=-1")
...
IF (ENABLE_INTEL_PHI)
  ...
  ELSE ()
    SET(INTEL_PHI_FLAGS "-xMIC_AVX512")
